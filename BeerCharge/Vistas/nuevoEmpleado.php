        ...
        <div class="col-xs-12 col-sm-8 col-md-4 col-sm-offset-2 col-md-offset-4">
        	<div class="panel panel-default">
        		<div class="panel-heading">
			    		...
			    		<form role="form" method="POST" action="<?php echo DIR . 'admin/registrar';?>">
			    			<div class="row">
			    			...
			    			<div class="row">
			    				<div class="col-xs-6 col-sm-6 col-md-6">
			    					<div class="form-group">
			                		<input type="text" maxlength="8" name="dni" id="dni" class="form-control input-sm floatlabel" required="on" placeholder="Dni" '>
			    					</div>
			    				</div>
			    			</div>
